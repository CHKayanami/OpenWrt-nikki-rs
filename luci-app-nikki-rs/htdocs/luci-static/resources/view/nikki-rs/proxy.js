...
return view.extend({
    ...
    render: function (data) {
        ...
        o = s.taboption('proxy', form.Flag, 'only_proxy_fake_ip_and_whitelist', _('Only Proxy Fake-IP and Whitelist'));
        o.rmempty = false;
        ...
        o = s.taboption('bypass', form.Value, 'china_mainland_ip_url', _('China Mainland IP Download URL'));
        o.default = 'https://raw.githubusercontent.com/juewuy/ShellCrash/update/bin/geodata/china_ip_list.txt';
        o.rmempty = false;

        o = s.taboption('bypass', form.Button, 'update_china_mainland_ip');
        o.inputstyle = 'positive';
        o.inputtitle = _('Download China Mainland IP File');
        o.onclick = function () {
            return nikki.updateChinaMainlandIP().then(function () {
                ui.addNotification(null, E('p', _('China Mainland IP file downloaded successfully.')), 'info');
            });
        };
        ...
        o = s.taboption('bypass', form.Value, 'china_mainland_ip6_url', _('China Mainland IP6 Download URL'));
        o.default = 'https://raw.githubusercontent.com/juewuy/ShellCrash/update/bin/geodata/china_ipv6_list.txt';
        o.rmempty = false;

        o = s.taboption('bypass', form.Button, 'update_china_mainland_ip6');
        o.inputstyle = 'positive';
        o.inputtitle = _('Download China Mainland IP6 File');
        o.onclick = function () {
            return nikki.updateChinaMainlandIP6().then(function () {
                ui.addNotification(null, E('p', _('China Mainland IP6 file downloaded successfully.')), 'info');
            });
        };
