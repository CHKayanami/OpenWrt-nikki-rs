...
return view.extend({
    ...
    render: function (data) {
        ...
        m = new form.Map('nikki-rs', _('Nikki RS'), `${_('Transparent Proxy with clash-rs on OpenWrt.')} <a href="https://github.com/nikkinikki-org/OpenWrt-nikki/wiki" target="_blank">${_('How To Use')}</a>`);
